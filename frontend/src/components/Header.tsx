    ...
    <header className="border-b border-border bg-surface-1">
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5">
          <svg viewBox="0 0 600 120" xmlns="http://www.w3.org/2000/svg" height="28" style={{ display: 'block' }}>
            <g transform="translate(4, 4) scale(0.219)">
              <g fill="none">
                <circle cx="256" cy="256" r="158" stroke="#252a3a" strokeWidth="20"/>
                <circle cx="256" cy="256" r="118" stroke="#2e3347" strokeWidth="18"/>
                <circle cx="256" cy="256" r="82"  stroke="#4b4f6e" strokeWidth="14"/>
                <circle cx="256" cy="256" r="50"  stroke="#6366f1" strokeWidth="12"/>
              </g>
              <circle cx="256" cy="256" r="22" fill="#6366f1"/>
            </g>
            <text y="84" fontFamily="Helvetica Neue,Helvetica,Arial,sans-serif" fontSize="76" letterSpacing="-2">
              <tspan x="72" fontWeight="300" fill="#e2e8f0">nest</tspan>
